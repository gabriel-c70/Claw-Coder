...
- ```bash
  claw telemetry status - to see the current status of telemetry
  claw telemetry on - to turn it on if you want
  claw telemetry off - to turn it off if you want
```
